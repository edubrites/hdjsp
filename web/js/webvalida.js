...
/*---------------------------------------------------------------------
 * FunÁıes de manipulaÁ„o para tabelas
 *---------------------------------------------------------------------*/
 function Excluir(chave, frm) {
      ...
      if(table == "Estado"){
        ...
        if (confirm('Deseja excluir a Cidade do CÛdigo: ' + chave + '?')) {
            if(frm.acao.value == "alterar"){
        ...
        if (confirm('Deseja excluir o Cliente do CÛdigo: ' + chave + '?')) {
            if(frm.acao.value == "alterar"){
        ...
        if (confirm('Deseja excluir a Categoria do CÛdigo: ' + chave + '?')) {
            if(frm.acao.value == "alterar"){
        ...
        if (confirm('Deseja excluir o VeiculoCliente do CÛdigo: ' + chave + '?')) {
            if(frm.acao.value == "alterar"){
        ...
        if (confirm('Deseja excluir o Usuario do CÛdigo: ' + chave + '?')) {
            if(frm.acao.value == "alterar"){
        ...
        if (confirm('Deseja excluir a Marca do CÛdigo: ' + chave + '?')) {
            if(frm.acao.value == "alterar"){
        ...
        if (confirm('Deseja excluir o Modelo do CÛdigo: ' + chave + '?')) {
            if(frm.acao.value == "alterar"){
...
function ValidarCliente(frm){
     if(frm.nome.value == ""){
        ...
        alert("Favor, informe o endereÁo!");
        frm.endereco.focus();
        return false;
...
function ValidarVeiculo(frm){
    if(frm.placa.value == ""){
        ...
        alert("Favor,informe a descriÁ„o!");
        frm.descricao.focus();
        return false;
    }else
        return true;
